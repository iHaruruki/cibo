...
class ChewingFromLandmarksNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('mar_high', 0.38)         # 開いた判定
        self.declare_parameter('mar_low',  0.32)         # 閉じた判定
        self.declare_parameter('ema_alpha', 0.3)         # MAR平滑化
        self.declare_parameter('min_interval_sec', 0.25) # 二重カウント防止
        self.declare_parameter('show_debug', False)      # デバッグテキスト表示
